...
namespace OH_Opening_Hours\Util;
...
class Persistence {
  ...
  const HOLIDAYS_META_KEY = '_opoh_set_holidays';

  /** Meta key under which irregular opening data is saved in post meta */
  const IRREGULAR_OPENINGS_META_KEY = '_opoh_set_irregular_openings';
