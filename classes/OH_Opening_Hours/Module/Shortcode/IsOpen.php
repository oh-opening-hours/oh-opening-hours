...
class IsOpen extends AbstractShortcode {
  const FILTER_FORMAT_TODAY = 'opoh_is_open_format_today';
  const FILTER_FORMAT_NEXT = 'opoh_is_open_format_next';
   ...
   * @return    string|null             Formatted today message (after filter 'opoh_is_open_format_today')
   */
   ...
   * @param     array     $attributes   Shortcode attributes
   * @return    string|null             Formatted next period message (after filter 'opoh_is_open_format_next')
   */
