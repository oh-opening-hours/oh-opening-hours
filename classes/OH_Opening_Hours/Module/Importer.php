...
use OH_Opening_Hours\Module\CustomPostType\Set as SetCPT;
...
class Importer extends AbstractModule {
  ...
  const REGEX_OLD_WIDGET_KEY = '/^widget_opoh_(.*?)-([0-9]+)$/';

  protected static $widgetMap = array(
    'overview' => array(
      'oldId' => 'widget_widget_opoh_overview',
      'newId' => 'widget_widget_opoh_overview',
      'attributeMap' => array(
        'title' => 'title',
    ...
    'status' => array(
      'oldId' => 'widget_widget_opoh_status',
      'newId' => 'widget_widget_opoh_is_open',
      'attributeMap' => array(
        'title' => 'title',
    ...
    'holidays' => array(
      'oldId' => 'widget_widget_opoh_holidays',
      'newId' => 'widget_widget_opoh_holidays',
      'attributeMap' => array(
        'title' => 'title',
    ...
    'special_openings' => array(
      'oldId' => 'widget_widget_opoh_special_openings',
      'newId' => 'widget_widget_opoh_irregular_openings',
      'attributeMap' => array(
        'title' => 'title',
        'highlighted' => 'highlight'
      )
  ...
  public function import() {
    ...
    add_action('admin_notices', array($this, 'addImportedNotice'));
  }

  public function addImportedNotice() {
    $class = 'notice notice-info is-dismissible';
    $message = __('Your Opening Hours and related widgets have automatically been upgraded to work with the updated version of the Plugin. Please double check your Opening Hours and Widgets.','oh-opening-hours');
