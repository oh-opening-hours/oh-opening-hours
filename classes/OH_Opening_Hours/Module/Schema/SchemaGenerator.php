...
namespace OH_Opening_Hours\Module\Schema;
 ...
 * @package OH_Opening_Hours\Module\Schema
 */
class SchemaGenerator {
  ...
  /**
   * Creates schema.org OH_Opening_HoursSpecification objects for the whole ValiditySequence
   * contained in `$vs` for the current Set.
   *
   * @param     ValiditySequence    $vs     The ValiditySequence from which to create the spec items
   * @return    array                       Array of associative arrays representing the OH_Opening_HoursSpecification
  ...
  /**
   * Creates OH_Opening_HoursSpecification objects for the current Set's Holidays.
   * All past items will not be considered.
   *
   * @return      array[]         Sequence of OH_Opening_HoursSpecification objects
  ...
  /**
   * Creates OH_Opening_HoursSpecification objects for the current Set's Irregular Openings.
   * All past items will not be considered.
   *
   * @return      array[]         Sequence of OH_Opening_HoursSpecification objects
  ...
  /**
   * Creates OH_Opening_HoursSpec definition objects from a validity period
   ...
   *
   * The OH_Opening_HoursSpec objects are represented as associative arrays.
   *
   *
