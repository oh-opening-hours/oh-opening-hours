...
use OH_Opening_Hours\Fields\FieldRenderer;
use OH_Opening_Hours\Fields\WidgetFieldRenderer;
use OH_Opening_Hours\Module\Shortcode\AbstractShortcode as Shortcode;
use WP_Widget;
...
abstract class AbstractWidget extends WP_Widget {
  ...
  public function form($instance) {
    ...
    echo '<p><a class="collapse-toggle">' . esc_html__('More Settings', 'oh-opening-hours') . '</a></p>';
    ...
    $filter_hook = 'opoh_widget_' . $this->widgetId . '_form_markup';
    echo apply_filters($filter_hook, $markup, $this);
  }

  /** Registers the Widget class in WordPress. Gets called in \OH_Opening_Hours\OH_Opening_Hours */
  ...
  public static function getPhpDateFormatInfo() {
    return sprintf(
      '<a href="https://www.php.net/manual/function.date.php" target="blank" rel="noopener noreferrer">%s</a>',
