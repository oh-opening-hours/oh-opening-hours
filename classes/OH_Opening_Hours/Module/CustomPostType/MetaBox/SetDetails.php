...
use OH_Opening_Hours\Fields\MetaBoxFieldRenderer;
...
class SetDetails extends AbstractMetaBox {
  const FILTER_ALIAS_PRESETS = 'opoh_set_alias_presets';
  ...
  public function renderMetaBox(WP_Post $post) {
    ...
    echo '<p>';
    echo '<h3>' . esc_html__('Set Id', 'oh-opening-hours')  . ': <code>' . esc_html($post->ID) . '</code></h3>';
    // prettier-ignore
    echo '<a class="op-generate-sc-link" data-shortcode-builder-url="' . esc_url($builderUrl) . '" href="' . esc_url($builderUrl) . '" target="_blank">' . esc_html__('Create a Shortcode', 'oh-opening-hours') . '</a>';
    echo '</h3>';
