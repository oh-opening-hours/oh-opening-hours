...
class SetTest extends OH_Opening_HoursTestCase {
  public function testIsHolidayActive() {
    $set = $this->createSet(
      ...
      array(
        new Holiday(
          'Holiday 1',
          new DateTime('2016-01-12', Dates::getTimezone()),
          new DateTime('2016-01-14', Dates::getTimezone())
        )
      )
    );
  ...
  public function testIsIrregularOpeningInEffect() {
    $set = $this->createSet(
      ...
      array(),
      array(),
      array(new IrregularOpening('Irregular Opening', '2016-01-13', '13:00', '17:00'))
    );
  ...
  public function testGetNextOpenPeriodOnlyPeriods() {
    ...
    $this->assertEquals(
      $periods[0]->getCopyInDateContext(new DateTime('2016-01-25', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-25 12:59', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[1]->getCopyInDateContext(new DateTime('2016-01-25', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-25 13:00', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[1]->getCopyInDateContext(new DateTime('2016-01-25', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-25 18:00', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[1]->getCopyInDateContext(new DateTime('2016-01-25', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-25 18:01', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[1]->getCopyInDateContext(new DateTime('2016-01-25', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-25 18:59', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[2]->getCopyInDateContext(new DateTime('2016-01-25', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-25 19:00', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[2]->getCopyInDateContext(new DateTime('2016-01-25', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-25 19:59', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[3]->getCopyInDateContext(new DateTime('2016-01-27', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-25 20:00', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[3]->getCopyInDateContext(new DateTime('2016-01-27', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-27 12:59', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[4]->getCopyInDateContext(new DateTime('2016-01-30', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-27 13:00', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[4]->getCopyInDateContext(new DateTime('2016-01-30', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-30 12:59', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[0]->getCopyInDateContext(new DateTime('2016-01-31', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-30 13:00', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[0]->getCopyInDateContext(new DateTime('2016-01-31', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-31 03:00', Dates::getTimezone()))
    );
    $this->assertEquals(
      $periods[0]->getCopyInDateContext(new DateTime('2016-01-31', Dates::getTimezone())),
      $set->getNextOpenPeriod(new DateTime('2016-01-31 03:01', Dates::getTimezone()))
    );
  }
  ...
  public function testGetNextOpenPeriodHolidays() {
    ...
    $this->assertEquals(
      $periods[4]->getCopyInDateContext(new DateTime('2016-01-30')),
      $set->getNextOpenPeriod(new DateTime('2016-01-27 12:59'))
    );
    $this->assertEquals(
      $periods[4]->getCopyInDateContext(new DateTime('2016-01-30')),
      $set->getNextOpenPeriod(new DateTime('2016-01-27 13:00'))
    );
    $this->assertEquals(
      $periods[0]->getCopyInDateContext(new DateTime('2016-09-26')),
      $set->getNextOpenPeriod(new DateTime('2016-02-05 13:00'))
    );
  }
  ...
  public function testIsOpen() {
    $set = $this->createSet(
      ...
      array(new Holiday('Test Holiday', new DateTime('2016-01-25'), new DateTime('2016-01-26'))),
      array(new IrregularOpening('IO', '2016-01-28', '15:00', '17:00'))
    );
  ...
  public function testGetDataForDate() {
    ...
    $expected = array(
      'periods' => array($periods[0], $periods[1], $periods[2]),
      'holidays' => array($holidays[0]),
      'irregularOpenings' => array($irregularOpenings[1])
    );
